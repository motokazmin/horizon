    ...
    , m_testInProgress(false)
{
    ...
    QObject::connect(m_driver, &IUTMDriver::connected, this, &HardwareController::onDriverConnected);
    QObject::connect(m_driver, &IUTMDriver::disconnected, this, &HardwareController::onDriverDisconnected);
    QObject::connect(m_driver, &IUTMDriver::stateChanged, this, &HardwareController::onStateChanged);
    QObject::connect(m_driver, &IUTMDriver::sensorDataReceived, this, &HardwareController::onSensorDataReceived);
    QObject::connect(m_driver, &IUTMDriver::testCompleted, this, &HardwareController::onTestCompleted);
    QObject::connect(m_driver, &IUTMDriver::errorOccurred, this, &HardwareController::onErrorOccurred);
